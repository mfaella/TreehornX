...
def make_system(function: Function, root: Var, trees: KnittedTrees, n: int = DEFAULT_N, m: int = DEFAULT_M, c: int = DEFAULT_C):
...
def check_sat(file_name: str, solver: CHCSolver = default_solver()) -> Status:
